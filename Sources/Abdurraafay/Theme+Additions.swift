...
//  
//
//  Created by Mohammad Abdurraafay on 2022-12-05.
//
...
private struct SiteFooter: Component {
    var body: Component {
        Footer {
            Paragraph {
                Text("Copyright © ")
                Node<HTML.BodyContext>.script("document.write(new Date().getFullYear())")
                Text(" Mohammad Abdurraafay")
                Paragraph {
                    Link("Twitter", url: "https://twitter.com/mohdabdurraafay")
                }
                Paragraph {
                    Link("LinkedIn", url: "https://linkedin.com/in/mohdabdurraafay")
                }
            }
        }
    }
